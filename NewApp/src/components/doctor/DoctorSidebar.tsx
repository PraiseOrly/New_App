  ...
  return <div className={`fixed left-0 top-0 h-full z-50 transition-all duration-300 ease-in-out
      ...
      <div className="flex flex-col h-full bg-white border-r border-gray-200">
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <button onClick={handleLogout} className="flex items-center w-full px-4 py-2 mt-4 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-md">
