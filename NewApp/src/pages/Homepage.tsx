...
const LearnMoreModal: React.FC<LearnMoreModalProps> = ({ isOpen, onClose, title, content, link }) => {
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-gray-600 mb-6 max-w-md mx-auto lg:mx-0 animate-fade-in">
                Empowering clinicians with AI-driven insights for precise diagnostics and better patient outcomes.
              </p>
              ...
              <Slideshow
                slides={[
                  ...
                  },
                  {
                    ...
                    alt: "Modern ECG equipment",
                    caption: "Cutting-Edge ECG Technology",
                  },
                  {
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-xl mx-auto animate-fade-in">
              Backed by rigorous clinical validation and certifications
            </p>
          </div>
          <Slideshow
            slides={[
              {
                ...
                caption: "Trusted by Clinicians Worldwide",
              },
              {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              {
                icon: <LineChartIcon className="text-red-600 mx-auto mb-4" size={36} />,
                value: "98.7%",
              ...
              {
                icon: <CalendarCheckIcon className="text-red-600 mx-auto mb-4" size={36} />,
                value: "2.5M+",
                text: "ECGs analyzed annually",
                modal: {
                  title: "ECG Analysis Volume",
                  content:
                    "Processing over 2.5 million ECGs annually, our platform scales to meet the demands of large healthcare systems while maintaining precision and reliability.",
                  link: "/ecg-analysis",
                },
              },
              {
                icon: <BadgeCheckIcon className="text-red-600 mx-auto mb-4" size={36} />,
                value: "CE",
                text: "Marked medical device certification",
                modal: {
                  title: "Certifications",
                  content:
                    "Certified with CE marking and FDA 510(k) clearance, our platform meets stringent regulatory standards for safety and efficacy in medical diagnostics.",
                  link: "/certifications",
                },
              },
            ].map((item, index) => (
              ...
              >
                ...
                <LearnMoreButton
                  onClick={() =>
                    openModal(item.modal.title, item.modal.content, item.modal.link)
                  }
                  label="Learn More"
                />
              </div>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-xl mx-auto animate-fade-in">
              FDA-cleared tools powered by AI for unparalleled clinical insights
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="lg:w-1/2 order-1 lg:order-2">
              ...
              <p className="text-gray-600 mb-4 text-sm sm:text-base animate-fade-in">
                Effortlessly integrate with major EHR systems like Epic and Cerner, embedding AI insights into your clinical workflows.
              </p>
              ...
              <LearnMoreButton
                onClick={() =>
                  openModal(
                    "EHR Integration",
                    "Our platform integrates seamlessly with Epic, Cerner, and other major EHR systems, enabling real-time data sync and automated workflows.",
                    "/ehr-integration"
                  )
                }
      ...
      <footer className="bg-gray-900 text-white py-10 px-4">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li>
                  <Link to="/ecg-analysis" className="hover:text-white transition-colors">
                    ECG Analysis
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/treatment-guidelines" className="hover:text-white transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li>
                  <Link to="/clinical-guidance" className="hover:text-white transition-colors">
                    Clinical Guidance
                  </Link>
                </li>
                <li>
                  <Link to="/research-library" className="hover:text-white transition-colors">
                    Research Library
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-gray-800 pt-6 text-center text-sm text-gray-400">
            <p>© {new Date().getFullYear()} CardiacAI. For professional use only.</p>
